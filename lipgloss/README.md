...
<p >
    ...
    <a href="https://pkg.go.dev/github.com/carmel/go-tui/lipgloss?tab=doc"><img src="https://godoc.org/github.com/golang/gddo?status.svg" alt="GoDoc"></a>
...
```bash
go get github.com/carmel/go-tui/lipgloss
```
...
For more on borders see [the docs](https://pkg.go.dev/github.com/carmel/go-tui/lipgloss#Border).
...
```go
import "github.com/carmel/go-tui/lipgloss/table"
```
...
```go
import "github.com/carmel/go-tui/lipgloss/list"
```
...
```go
import "github.com/carmel/go-tui/lipgloss/tree"
```
...
```go
import "github.com/carmel/go-tui/lipgloss/compat"
...
Lip Gloss doesn’t replace Bubble tui. Rather, it is an excellent Bubble Tea
...
[docs]: https://pkg.go.dev/github.com/carmel/go-tui/lipgloss?tab=doc
