...
to Lip Gloss v2 (`github.com/carmel/go-tui/lipgloss`). It is written for both humans and
...
```go
import (
    "github.com/carmel/go-tui/lipgloss/compat"
...
| Task                    | v1                                                    | v2                                                                                  |
| ----------------------- | ----------------------------------------------------- | ----------------------------------------------------------------------------------- |
| Import                  | `"github.com/charmbracelet/lipgloss"`                 | `"github.com/carmel/go-tui/lipgloss"`                                               |
