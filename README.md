...
<p>
    ...
    <a href="https://github.com/carmel/go-tui/releases"><img src="https://img.shields.io/github/release/charmbracelet/bubbletea.svg" alt="Latest Release"></a>
    <a href="https://pkg.go.dev/github.com/carmel/go-tui?tab=doc"><img src="https://godoc.org/github.com/carmel/go-tui?status.svg" alt="GoDoc"></a>
    <a href="https://github.com/carmel/go-tui/actions"><img src="https://github.com/carmel/go-tui/actions/workflows/build.yml/badge.svg?branch=main" alt="Build Status"></a>
</p>
...
Be sure to check out [Bubbles][bubbles], a library of common UI components for Bubble tui.
...
[tut-source]: https://github.com/carmel/go-tui/tree/main/tutorials/basics
...
`tui.View`. The view declares our UI content and, optionally, terminal features
...
[cmd]: https://github.com/carmel/go-tui/tree/main/tutorials/commands/
[examples]: https://github.com/carmel/go-tui/tree/main/examples
[docs]: https://pkg.go.dev/github.com/carmel/go-tui?tab=doc
...
if len(os.Getenv("DEBUG")) > 0 {
	f, err := tui.LogToFile("debug.log", "debug")
	if err != nil {
...
There are over [18,000 applications](https://github.com/carmel/go-tui/network/dependents) built with Bubble Tea! Here are a handful of ’em.
...
[contribute]: https://github.com/carmel/go-tui/contribute
...
[MIT](https://github.com/carmel/go-tui/raw/main/LICENSE)
