...
+import "github.com/carmel/go-tui/glamour"
+import "github.com/carmel/go-tui/glamour/ansi"
+import "github.com/carmel/go-tui/glamour/styles"
```

## Update Dependencies

```bash
go get github.com/carmel/go-tui/glamour@latest
```

If you need color downsampling (most apps do):

```bash
go get github.com/carmel/go-tui/lipgloss@latest
```
...
```bash
go get github.com/carmel/go-tui/glamour
```
